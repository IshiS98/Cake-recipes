    ...
    return (
      <>
        <ScrollView>
          ...
          <Image source={Images.ButterIcing} style={styles.Image} />
          <Text style={styles.Text1}> Ingredients : </Text>
          <Text style={styles.Text2}> * Icing Sugar = 1kg </Text>
          ...
          <Text style={styles.Text2}>
            3. take a spoon and stire icing sugar, butter, milk and vanila well.
          </Text>
          <Text style={styles.Text2}>
