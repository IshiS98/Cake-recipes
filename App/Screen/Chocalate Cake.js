    ...
    return (
      <>
        <ScrollView>
          ...
          <Image source={Images.ChocalateCake} style={styles.Image} />
          ...
          <Text style={styles.Text2}> * Chocalate powder = 75g </Text>
          <Text style={styles.Text2}> * Backing powder = 1 1/2 ts </Text>
          <Text style={styles.Text2}> * Baking soda = 1 ts</Text>
          ...
          <Text style={styles.Text2}>
            ...
            with chocalate powder, baking powder, baking soda and stir well.
          </Text>
